...
### Основа на проекта
За направата на проекта е използван **шаблонът и GitHub repository-то**, които се използват на упражненията по диспциплината "Компютърна графика".

### Промени и Допълнения
В това repository са качени **всички промени и допълнения** по кода, които удовлетворяват изискванията за курсов проект.

### Документация
**[ПЪЛНА ДОКУМЕНТАЦИЯ НА ПРОЕКТА](121222139_Cp-1_CG.docx)** - Кликнете за да изтеглите подробната документация
...
- **Интерактивно управление** (движение и завъртане)
- **Анимации** на всички части на робота
- **GUI контролен панел** с ImGui
